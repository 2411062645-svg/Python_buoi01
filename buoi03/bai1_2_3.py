...
print("\n=== HOẠT ĐỘNG 2: Duyệt List & Ma trận ===")
...
print("In ra tung phan tu:")
for hang in ma_tran:
    for phan_tu in hang:
        print(phan_tu, end=" ")
    print()

# --- YÊU CẦU TÔ VÀNG HOẠT ĐỘNG 2 ---
# Viết thêm đoạn code tính tổng tất cả các phần tử trong ma_tran bằng cách dùng biến tong cộng dồn qua 2 vòng for lồng nhau
tong_ma_tran = 0
for hang in ma_tran:
    for phan_tu in hang:
        tong_ma_tran += phan_tu
print("Tổng tất cả các phần tử trong ma trận là:", tong_ma_tran)
